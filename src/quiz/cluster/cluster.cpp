...
void proximity(const std::vector<std::vector<float>>& points,std::vector<int> cluster, std::vector<bool> processed,int index, KdTree* tree, float distanceTol)
{
	processed[index]=true;
	cluster.push_back(index);

	std::vector<int> neighbor_point = tree->search(points[index], distanceTol);
